...
The Alchemy CLI exposes a utility for creating Cloudflare tokens that follow a profile
<Tabs syncKey="pkgManager">
  <TabItem label="bun">
    ```sh
    bun alchemy util create-cloudflare-token --profile <profile>
    ```
  </TabItem>
  <TabItem label="npm">
    ```sh
    npx alchemy util create-cloudflare-token --profile <profile>
    ```
  </TabItem>
  <TabItem label="pnpm">
    ```sh
    pnpm alchemy util create-cloudflare-token --profile <profile>
    ```
  </TabItem>
  <TabItem label="yarn">
    ```sh
    yarn alchemy util create-cloudflare-token --profile <profile>
    ```
  </TabItem>
</Tabs>

as well as a utility for creating "god tokens" with full write access to everything in a cloudflare account:
<Tabs syncKey="pkgManager">
  <TabItem label="bun">
    ```sh
    bun alchemy util create-cloudflare-token --god-token
    ```
  </TabItem>
  <TabItem label="npm">
    ```sh
    npx alchemy util create-cloudflare-token --god-token
    ```
  </TabItem>
  <TabItem label="pnpm">
    ```sh
    pnpm alchemy util create-cloudflare-token --god-token
    ```
  </TabItem>
  <TabItem label="yarn">
    ```sh
    yarn alchemy util create-cloudflare-token --god-token
    ```
  </TabItem>
</Tabs>
